            ...
            <div id="filtros" class="p-4 mb-4 md:p-6 bg-white rounded-lg hidden dark:bg-[#252c47]">
                <div class="mb-2 sm:grid sm:gap-x-6 xl:grid-cols-3 lg:mb-0">
                    <div class="w-full lg:w-[300px] mb-6 sm:mb-4">
                        ...
                        <select name="evento_id" class="lg:max-w-[250px] mb-1 bg-white border border-gray-300 text-gray-500 rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full dark:bg-[#1c2039] dark:border-[#343d61] dark:text-[#d0d9e6]">
                    ...
                    <div class="w-full mb-6 sm:mb-4">
                        ...
                        <input type="date" name="dt_escala" id="dt_escala"
                               class="border-gray-300 w-full rounded-lg text-gray-500 lg:max-w-[250px] dark:bg-[#1c2039] dark:border-[#343d61] dark:text-[#d0d9e6]"
                            ...
                            <li class="w-full border-b border-gray-300 lg:border-b-0 lg:border-r dark:border-[#343d61]">
                                <div class="flex items-center pl-3">
                                    <input id="escala-fechada-option-0" type="radio" checked value="" name="fechada"
                                           class="w-3 h-3 text-gray-500 bg-gray-100 border-gray-300 focus:ring-gray-300 focus:ring-1 dark:bg-[#252c47] dark:border-[#343d61] dark:focus:ring-0 dark:checked:bg-yellow-400">
                                    <label for="escala-fechada-option-0" class="py-2 ml-2 mr-3 w-full font-thin text-sm text-gray-600 dark:text-[#d0d9e6]">
                                        Todos
                                    </label>
                                </div>
                            </li>
                            <li class="w-full border-b border-gray-300 lg:border-b-0 lg:border-r dark:border-[#343d61]">
                                <div class="flex items-center pl-3">
                                    ...
                                    id="escala-fechada-option-1" type="radio" value="1" name="fechada"
                                           class="w-3 h-3 text-gray-500 bg-gray-100 border-gray-300 focus:ring-gray-300 focus:ring-1 dark:bg-[#252c47] dark:border-[#343d61] dark:focus:ring-0 dark:checked:bg-yellow-400">
                                    <label for="escala-fechada-option-1" class="py-2 ml-2 mr-3 w-full font-thin text-sm text-gray-600 dark:text-[#d0d9e6]">
                                        Sim
                                    </label>
                                </div>
                            </li>
                            <li class="w-full">
                                <div class="flex items-center pl-3">
                                    ...
                                    id="escala-fechada-option-2" type="radio" value="0" name="fechada"
                                           class="w-3 h-3 text-gray-500 bg-gray-100 border-gray-300 focus:ring-gray-300 focus:ring-1 dark:bg-[#252c47] dark:border-[#343d61] dark:focus:ring-0 dark:checked:bg-yellow-400">
                                    <label for="escala-fechada-option-2" class="py-2 ml-2 mr-3 w-full font-thin text-sm text-gray-600 dark:text-[#d0d9e6]">
                                        Não
                                    </label>
                                </div>
                            </li>
