...
<head>
    ...
    <meta name="description"
          content="A Igreja Evangélica Ministério Semeando a Verdade é uma igreja que preza pela Palavra de Deus,
          cujo propósito é fazer com que o evangelho do Senhor Jesus Cristo seja proclamado,
          anunciado e propagado em toda a Terra.">
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="{{ asset('css/app.css') }}?v=106">
...
<body class="grid grid-rows-[auto_1fr] min-h-dvh bg-gray-100">
