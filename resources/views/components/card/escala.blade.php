...
<div class="flex flex-col bg-white text-gray-600 shadow-sm rounded-md border-[1px] border-gray-200 relative dark:text-[#d0d9e6] dark:bg-[#252c47] dark:border-[#252c47]">
