...
<div class="flex flex-col bg-white rounded-sm my-1 px-4 pb-3 sm:my-4 md:my-4 md:px-6 md:pb-4 shadow-md shadow-gray-200">
    <div class="flex relative border-b border-b-gray-200">
        ...
        <div class="relative py-3 pl-3 sm:py-6 sm:pl-6 md:p-6 md:py-4 w-full">
            <div class="">
                <div class="font-medium tracking-tighter sm:text-lg md:text-2xl">{{ $escala->classe->nome }}</div>
            ...
            <div class="block sm:flex sm:gap-12 md:gap-16 lg:gap-0 lg:justify-between">
                ...
                @if($escala->monitor)
                    <div class="mt-2 sm:mt-3 md:mt-4">
                        ...
                        <div
                            class="text-gray-500 text-sm font-thin md:text-ellipsis md:overflow-hidden md:line-clamp-1">
                            {{ $escala->monitor }}&nbsp;
                        </div>
                    </div>
                @endif
