...
<div class="bg-white border border-gray-200 rounded-md shadow-sm relative dark:bg-[#252c47] dark:border-[#252c47]">
    ...
    <div class="flex p-4">
        ...
        <div class="flex-1 grid grid-cols-2 gap-y-2 ml-2">
            <div class="flex flex-col col-span-2">
                <div class="text-gray-700 dark:text-[#d0d9e6] leading-4 text-lg font-semibold sm:font-medium">
                    {{ $voluntario->nome }}
                </div>
            </div>
            <div class="flex flex-col grid-cols-1">
                <div class="font-thin text-xs md:text-sm text-gray-400">Sexo</div>
                <div class="text-gray-700 leading-4 dark:text-[#d0d9e6]">{{ $voluntario->sexo === 'M' ? 'Masculino' : 'Feminino' }}</div>
            </div>
            <div class="flex flex-col">
                <div class="font-thin text-xs md:text-sm text-gray-400">Professor EBD</div>
                <div class="text-gray-700 leading-4 dark:text-[#d0d9e6]">{{ $voluntario->professor_ebd == '1' ? 'Sim' : 'Não' }}</div>
            </div>
    ...
    @canany(['adm-editar-voluntario', 'adm-excluir-voluntario'])
        <div class="text-sm flex gap-2 border-t border-t-gray-100 dark:border-t-[#34384e] px-4 md:px-6 py-3">
